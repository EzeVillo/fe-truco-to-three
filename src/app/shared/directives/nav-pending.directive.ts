 ...
 * que la navegación termina. Aplica la clase `is-nav-pending` (loader + bloqueo
 * de más clicks vía CSS) y `aria-busy`.
 *
 ...
 * aspecto, así que el usuario creía que no había funcionado y volvía a tocar.
 */
@Directive({
